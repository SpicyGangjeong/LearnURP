...
namespace Logic
{
    namespace State
    {
        ...
        public class CState_Player_Initialize : CState_Player
        {
            ...
            {
                public STATE_PLAYER_INITIALIZE_DESC(MonoBehaviour pOwner, CFSM pFsm, CGameInstance pGameInstance)
                    : base((int)PlayerState.INITIALIZE, pOwner, pFsm, pGameInstance)
                {
